...
# ![VeReMi](/assets/veremi_logo.svg)  Dataset (v1)

This is the first, initial version of the Vehicular Reference Misbehavior (VeReMi) dataset, a dataset for the evaluation of misbehavior detection mechanisms for VANETs.
